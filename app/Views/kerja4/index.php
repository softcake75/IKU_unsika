              ...
              foreach ($kerja4 as $row) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <a href="<?php echo base_url('/kerja4/edit/' . $row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                    </div>
                  </td>
                </tr>
              <?php } ?>
...
<!-- Add Data -->
<form action="/kerja4/save" method="post">
