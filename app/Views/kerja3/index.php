              ...
              foreach ($kerja3 as $row) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <a href="<?php echo base_url('/kerja3/edit/' . $row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                    </div>
                  </td>
                </tr>
              <?php } ?>
...
<!-- Add Data -->
<form action="/kerja3/save" method="post">
