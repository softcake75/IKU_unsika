...
<?php echo view('layout/sidebar')?>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>IKU 3 (Dosen Sebagai Praktisi)</h1>
            <div class="section-header-breadcrumb">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_iku3_b">Tambah data</button>
            </div>
          </div>
                      ...
                      <table id="mydata" class="table  table-bordered table-md" style="width:100%">
                        <thead>
                            <tr>
                              ...
                              <th class="text-center">Tautan Kontrak/SK</th>
                          ...
                          $no = 1;
                            foreach($iku3_b as $row) { ?>
                              <tr>
                                  ...
                                  <td class="text-center">
                                      <div class="btn-group">
                                      <a href="<?php echo base_url('/iku3_b/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          
                                          <a href="<?php echo base_url('/iku3_b/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
    ...
    <!-- Add Data -->
    <form action="/iku3_b/save" method="post">
        <div class="modal fade" id="add_iku3_b" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Kriteria Pengalaman</label>
                    <input type="text" class="form-control" name="jenis_pt" placeholder="Masukan Jenis Kegiatan">
                </div>
                <div class="form-group">
