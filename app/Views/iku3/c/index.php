...
<?php echo view('layout/sidebar')?>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_iku3_c">Tambah data</button>
            </div>
          </div>
                      ...
                      <table id="mydata" class="table  table-bordered table-md" style="width:100%">
                        <thead>
                            <tr>
                              ...
                              <th class="text-center">Tahun Kompetisi</th>
                              <th class="text-center">Tautan Data Dukung</th>
                              <th class="text-center">Tautan SK Mahasiswa Berprestasi</th>
                          ...
                          $no = 1;
                            foreach($iku3_c as $row) { ?>
                              <tr>
                                  ...
                                  <td class="text-center"><?php echo $row['tahun_kompetisi']; ?></td>
                                  ...
                                  <td class="text-center">
                                      ...
                                      <a href="<?php echo base_url('/iku3_c/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          ...
                                          <a href="<?php echo base_url('/iku3_c/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
    ...
    <form action="/iku3_c/save" method="post">
        <div class="modal fade" id="add_iku3_c" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
