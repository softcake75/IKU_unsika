...
<?php echo view('layout/sidebar')?>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_iku3_a">Tambah data</button>
            </div>
          </div>
                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                      ...
                                      <a href="<?php echo base_url('/iku3_a/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          ...
                                          <a href="<?php echo base_url('/iku3_a/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
    ...
    <form action="/iku3_a/save" method="post">
        <div class="modal fade" id="add_iku3_a" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
