                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select name="jenis_pt" type="text"class="form-control" value="<?php echo $iku3_a['jenis_pt']; ?>">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select name="jenis_kegiatan" type="text"class="form-control" value="<?php echo $iku3_a['jenis_kegiatan']; ?>">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input name="status_validasi" type="text"class="form-control" value="<?php echo $iku3_a['status_validasi']; ?>">
