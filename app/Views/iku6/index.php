                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                      ...
                                      <a href="<?php echo base_url('/iku6/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          ...
                                          <a href="<?php echo base_url('/iku6/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
    ...
    <form action="/iku6/save" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Jenjang</label>
                    <input type="text" class="form-control" name="jenjang" placeholder="Masukan Jenis Kegiatan">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="bentuk_kerjasama" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
                    <label>Kriteria Mitra</label>
                    <input type="number" class="form-control" name="kriteria_mitra" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
                    <label>Nama Mitra</label>
                    <input type="number" class="form-control" name="nama_mitra" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
                    <label>Kegiatan Kerjasama</label>
                    <input type="number" class="form-control" name="kegiatan_kerjasama" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
                    <label>Periode Kerjasama</label>
                    <input type="number" class="form-control" name="periode" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
                    <label>Tautan MoU</label>
                    <input type="text" class="form-control" name="mou" placeholder="Masukan Program/Kegiatan">
                </div>
                <div class="form-group">
                    <label>Tautan MoA</label>
                    <input type="text" class="form-control" name="moa" placeholder="Masukan Program/Kegiatan">
                </div>
                <div class="form-group">
                    <label>Tautan IA</label>
                    <input type="text" class="form-control" name="ia" placeholder="Masukan Program/Kegiatan">
                </div>
                <div class="form-group">
                    <label>Jenis Luaran Kerjasama</label>
                    <input type="text" class="form-control" name="jenis_luaran" placeholder="Masukan Program/Kegiatan">
                </div>
                <div class="form-group">
                    <label>Jumlah Luaran Kerjasama</label>
                    <input type="text" class="form-control" name="jumlah_luaran" placeholder="Masukan Program/Kegiatan">
                </div>
                <div class="form-group">
