                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                      ...
                                      <a href="<?php echo base_url('/iku4_b/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          ...
                                          <a href="<?php echo base_url('/iku4_b/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_lembaga" placeholder="Masukan Jenis Kegiatan">
                </div>
                <div class="form-group">
                    <label>Nama</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lembaga_sertifikasi" placeholder="Masukan Nama">
                </div>
                <div class="form-group">
                    <label>Tautan Sertifikat</label>
                    <input type="number" class="form-control" name="tautan_sertifikat" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
