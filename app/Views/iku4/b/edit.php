      ...
      <form action="<?php echo base_url('iku4_a/update/' . $iku_4_a['id']); ?>" method="post">
        <div class="card-body">
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <select name="jenis_lembaga" type="text" class="form-control">
                <option value="Lembaga Sertifikasi Profesi (LSP)" <?php if ($iku3_a['jenis_lembaga'] == 'Lembaga Sertifikasi Profesi (LSP)') echo 'selected' ?>>Lembaga Sertifikasi Profesi (LSP)</option>
                <option value="Lembaga Sertifikasi Kompetensi (LSK)" <?php if ($iku3_a['jenis_lembaga'] == 'Lembaga Sertifikasi Kompetensi (LSK)') echo 'selected' ?>>Lembaga Sertifikasi Kompetensi (LSK)</option>
                <option value="Lembaga Sertifikasi Internasional" <?php if ($iku3_a['jenis_lembaga'] == 'Lembaga Sertifikasi Internasional') echo 'selected' ?>>Lembaga Sertifikasi Internasional</option>
                <option value="Sertifikasi Perusahaan Fortune 500" <?php if ($iku3_a['jenis_lembaga'] == 'Sertifikasi Perusahaan Fortune 500') echo 'selected' ?>>Sertifikasi Perusahaan Fortune 500</option>
                <option value="Sertifikasi Perusahaan BUMN" <?php if ($iku3_a['jenis_lembaga'] == 'Sertifikasi Perusahaan BUMN') echo 'selected' ?>>Sertifikasi Perusahaan BUMN</option>
              </select>
            </div>
          </div>
          <div class="form-group row mb-4">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="lembaga_sertifikasi" value="<?php echo $iku_4_a['lembaga_sertifikasi']; ?>">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tautan Sertifikasi</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="tautan_sertifikasi" value="<?php echo $iku_4_a['tautan_sertifikasi']; ?>">
            </div>
          </div>
          <div class="form-group row mb-4">
