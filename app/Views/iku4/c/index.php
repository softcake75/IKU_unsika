                          ...
                          $no = 1;
                            foreach($iku4_c as $row) { ?>
                              <tr>
                                  ...
                                  <td class="text-center">
                                      <div class="btn-group">
                                      <a href="<?php echo base_url('/iku4_c/edit/'.$row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                          
                                          <a href="<?php echo base_url('/iku4_c/delete/'.$row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $row['jenis_kegiatan']; ?> ini?')"><i class="fas fa-trash-alt"></i></a>
                                      </div>
                                  </td>
                              </tr>
                            <?php } ?>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_pengalaman" placeholder="Masukan Jenis Kegiatan">
                </div>
                <div class="form-group">
                    <label>Nama</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_instansi" placeholder="Masukan Nama">
                </div>
                <div class="form-group">
                    <label>Tautan Pengalaman Kerja</label>
                    <input type="number" class="form-control" name="tautan_pengalaman_kerja" placeholder="Masukan NIM">
                </div>
                <div class="form-group">
