                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              ...
                              <a href="<?php echo base_url('/iku4_c/delete/' . $row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus <?php echo $row['nama']; ?>?')"><i class="fas fa-trash-alt"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php } ?>
