...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Akreditasi Internasional</h1>
              ...
              foreach ($kerja8 as $row) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <a href="<?php echo base_url('/kerja8/edit/' . $row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                    </div>
                  </td>
                </tr>
              <?php } ?>
...
<!-- Add Data -->
<form action="/kerja8/save" method="post">
